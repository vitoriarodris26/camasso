    ...
    <section className="bg-gray-50 py-24 relative" id="produtos">
      <div className="container mx-auto px-6 text-center mb-12">
        ...
        <p className="text-gray-500 max-w-2xl mx-auto text-lg leading-relaxed">
          Conheça nossos produtos desenvolvidos para oferecer soluções completas de identificação para diversos setores.
        </p>
      </div>
        ...
        <div className="bg-white rounded-[3rem] p-6 md:p-10 shadow-sm border border-gray-100">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-gray-50/50 rounded-[2.5rem] p-8 md:p-12 flex flex-col items-center justify-center text-center border border-gray-100">
              ...
              <h3 className="text-3xl md:text-4xl font-semibold text-gray-900 mb-4">Performance Superior</h3>
              <p className="text-gray-400 mb-8 max-w-sm text-sm leading-relaxed">
                Hardware de alta confiabilidade para impressão de etiquetas e pulseiras.
              </p>
              <button onClick={() => navigate(ROUTES.CATALOGO)} className="bg-black text-white px-8 py-3.5 rounded-full font-bold text-sm hover:opacity-85 transition-all active:scale-95 shadow-lg">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-black/60 backdrop-blur-sm" onClick={() => setIsModalOpen(false)}>
          <div className="bg-white w-full max-w-4xl rounded-[2.5rem] overflow-hidden flex flex-col md:flex-row relative animate-in zoom-in duration-300" onClick={e => e.stopPropagation()}>
            ...
            <div className="w-full md:w-1/2 p-10 flex flex-col justify-center">
              ...
              <a href={`https://wa.me/5511975361817?text=Interesse no produto: ${selectedProduct.title}`} target="_blank" className="bg-[#008542] text-white text-center py-4 rounded-2xl font-bold hover:bg-[#006d36] transition-colors">
                Solicitar Orçamento
              </a>
            </div>
          </div>
