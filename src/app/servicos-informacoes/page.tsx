          ...
          >
            ...
            <div className="p-8 md:p-16 w-full flex flex-col justify-center overflow-y-auto">
              ...
              <a 
                ...
                target="_blank"
                className="flex items-center w-[300px] justify-center gap-1 bg-green-600 text-white py-5 rounded-2xl font-black text-lg hover:bg-green-700 transition-all hover:scale-[1.02] shadow-xl shadow-green-100"
              >
