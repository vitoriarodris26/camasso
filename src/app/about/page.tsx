...
export const metadata = {
  ...
  description: "Saiba mais sobre a trajetória da Camasso e nosso compromisso com a excelência.",
};

const cards = [
  {
    titulo: "Valores",
    texto: "Ética, transparência, inovação, foco no cliente, trabalho em equipe, perseverança e superação.",
    Icone: Heart,
  },
  {
    titulo: "Missão",
    texto: "Implementar soluções em produtos e serviços que gerem agilidade e economia a nossos clientes, com qualidade e excelência em atendimento.",
    Icone: Target,
  },
  {
    titulo: "Visão",
    texto: "Inovar e destacar-se como referência no mercado, trazendo a melhor experiência e maior confiabilidade aos nossos clientes e parceiros.",
    Icone: Eye,
  },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.8fr_1.2fr] gap-8 lg:gap-16 items-center">
            ...
            <div className="space-y-3">
              <div className="space-y-6 scroll-mt-32" id="quem-somos">
                <span className="bg-green-100 text-green-600 px-4 py-1 rounded-full text-xs font-bold uppercase inline-block mb-4">
                  quem somos?
                </span>
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
                  Inovação em cada detalhe da <span className="text-green-500">produção</span>.
                </h1>
              </div>
              
              <p className="text-gray-600 text-base md:text-lg leading-relaxed max-w-2xl">
                A Camasso é uma empresa versátil e consolidada que se destaca em soluções para identificação. Com uma estrutura própria e dinâmica, atende com excelência a todo o território nacional.
              </p>
        ...
        <div className="container mx-auto px-4 lg:px-24">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {cards.map((item, index) => (
              ...
              >
                <h3 className="text-green-600 font-bold text-lg">{item.titulo}</h3>
