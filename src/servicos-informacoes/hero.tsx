    ...
    <section className="relative min-h-[80vh] flex items-center pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
      ...
      <div className="container mx-auto px-2 relative z-10">
        <div className="max-w-2xl animate-fade-in-up">
          <h1 className="text-5xl lg:text-6xl font-bold leading-tight mb-6 text-white pl-4">
            Serviços<br />
            <span className="text-[#10b981]">da Camasso</span>
          </h1>
          
          <p className="text-gray-200 text-lg mb-8 leading-relaxed max-w-lg pl-4">
            Explore nossos serviços e informações, qualquer dúvida entre em contato conosco.
          </p>
